...
# Read Excel file
df<-read_excel("C:\\Users\\profi\\Documents\\UNSW Civil Engineering\\Year 4\\T3\\Research Thesis CVEN4951\\Waymo Data\\Extracted_Data\\Used\\Frame Data (0000_10050)\\final_data (complete).xlsx", sheet = 'Raw')
