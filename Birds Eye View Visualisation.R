...
# Read Excel file
df<-read_excel("C:\\Users\\profi\\Documents\\UNSW Civil Engineering\\Year 4\\T3\\Research Thesis CVEN4951\\Waymo Data\\Extracted_Data\\Used\\Frame Data (0002_11392)\\birds_eye_data (complete).xlsx", sheet = 'Raw')
...
# NB: IF YOU REQUIRE BIRDS EYE VIEW FOR ONE FRAME ONLY, RUN THE FOLLOWING:
